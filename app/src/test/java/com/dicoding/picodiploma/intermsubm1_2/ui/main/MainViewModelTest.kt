...
import com.dicoding.picodiploma.intermsubm1_2.DataDummy
import com.dicoding.picodiploma.intermsubm1_2.MainDispatcherRule
import com.dicoding.picodiploma.intermsubm1_2.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(mainRepository.getQuote()).thenReturn(expectedQuote)
